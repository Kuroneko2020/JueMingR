...
{
    internal enum HotkeyPopupCommand { None = -1, Record, Clear, Close, Help, Details, DetailUp, DetailDown }
    ...
    internal sealed class HotkeyPopupView
    {
        ...
        internal readonly bool Editable, Capturing, Known, DetailsExpanded;
        internal HotkeyPopupView(string title, HotkeyChord effective, HotkeyChord candidate, HotkeyModifiers modifiers,
            HotkeyFeedback feedback, bool editable, bool capturing, bool known, bool detailsExpanded = false)
        { Title = title; Effective = effective; Candidate = candidate; Modifiers = modifiers; Feedback = feedback; Editable = editable; Capturing = capturing; Known = known; DetailsExpanded = detailsExpanded; }
        ...
        { return other != null && Title == other.Title && Equals(Effective, other.Effective) && Equals(Candidate, other.Candidate) && Modifiers == other.Modifiers &&
            ReferenceEquals(Feedback, other.Feedback) && Editable == other.Editable && Capturing == other.Capturing && Known == other.Known && DetailsExpanded == other.DetailsExpanded; }
    }
}
