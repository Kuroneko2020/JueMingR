...
{
    internal enum ItemUiCommand { Enable, Disable, Add, Replace, Remove, Select, Confirm, Cancel, ToggleDiscardFeedback, Hotkey, Quick, QuickHotkey, Coin, Processing, Tools }
