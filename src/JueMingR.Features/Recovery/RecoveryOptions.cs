...
namespace JueMingR.Features.Recovery
{
    ...
    public sealed class RecoveryOptions
    {
        ...
        public RecoveryOptions(int lifeMode=0,bool mana=false,bool buffs=false,bool followAdd=false,bool followRemove=false,
            bool nurse=false,bool furniture=false,bool tax=false,IEnumerable<int> noLife=null,IEnumerable<int> noMana=null,IEnumerable<int> allowedBuffs=null)
        {
        ...
        { return new RecoveryOptions(feature==0?value:LifeMode,feature==1?value!=0:Mana,feature==4?value!=0:Buffs,feature==6?value!=0:FollowAdd,
            feature==7?value!=0:FollowRemove,feature==2?value!=0:Nurse,feature==3?value!=0:Furniture,feature==5?value!=0:Tax,NoLife,NoMana,AllowedBuffs); }
        public RecoveryOptions ChangeType(int list,int type,bool include)
        {
            ...
            return new RecoveryOptions(LifeMode,Mana,Buffs,FollowAdd,FollowRemove,Nurse,Furniture,Tax,list==0?(IEnumerable<int>)types:NoLife,list==1?(IEnumerable<int>)types:NoMana,list==2?(IEnumerable<int>)types:AllowedBuffs);
        }
        public RecoveryOptions ClearBuffs(){return new RecoveryOptions(LifeMode,Mana,Buffs,FollowAdd,FollowRemove,Nurse,Furniture,Tax,NoLife,NoMana);}
    }
}
