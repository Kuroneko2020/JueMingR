...
namespace JueMingR.Features.Notes
{
    public sealed class Note
    {
        ...
        public Note Pin(int x, int y) { return new Note(this, Title, titleBoundaries, Body, bodyBoundaries, true, x, y, 0); }
        public Note Unpin() { return new Note(this, Title, titleBoundaries, Body, bodyBoundaries, false, X, Y, Opacity); }
