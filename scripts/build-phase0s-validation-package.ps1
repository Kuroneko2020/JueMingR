...
param(
    ...
    [ValidateSet('Phase0S', 'Phase0TBiome', 'Phase0UF5UI', 'Phase0VSettings', 'Phase0WNotes', 'ItemAutomation', 'UnifiedHotkeys', 'EntityLabels', 'WorldTargets', 'WorldObjectText', 'InformationSummary', 'DirectionEquipment', 'DeathHistory', 'MapMarkersExploration', 'Footprints', 'ItemBrowser', 'KeepFavoritedQuickItems', 'CoinDeposit', 'AboutHelpFeedback')]
...
$ownerTestCardName = if ($Profile -eq 'AboutHelpFeedback') { 'About-Help-Feedback-Owner-Test-Card.zh-CN.md' } elseif ($Profile -eq 'CoinDeposit') { 'Coin-Deposit-Owner-Test-Card.zh-CN.md' } elseif ($Profile -eq 'KeepFavoritedQuickItems') { 'Keep-Favorited-Quick-Items-Owner-Test-Card.zh-CN.md' } elseif ($Profile -eq 'ItemBrowser') { 'Item-Browser-Owner-Test-Card.zh-CN.md' } elseif ($Profile -eq 'Footprints') { 'Footprints-Owner-Test-Card.zh-CN.md' } elseif ($Profile -eq 'MapMarkersExploration') { 'Map-Markers-Exploration-Owner-Test-Card.zh-CN.md' } elseif ($Profile -eq 'DeathHistory') {
    'Death-History-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'DirectionEquipment') {
    'Direction-Equipment-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'InformationSummary') {
    'Information-Summary-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'WorldObjectText') {
    'World-Object-Text-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'WorldTargets') {
    'World-Targets-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'EntityLabels') {
    'Entity-Labels-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'UnifiedHotkeys') {
...
} elseif ($Profile -eq 'Phase0VSettings') {
    'Phase0V-Settings-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'Phase0UF5UI') {
    'Phase0U-F5UI-Owner-Test-Card.zh-CN.md'
} elseif ($Profile -eq 'Phase0TBiome') {
