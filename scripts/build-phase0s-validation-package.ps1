...
param(
    ...
    [ValidateSet('Phase0S', 'Phase0TBiome', 'Phase0UF5UI', 'Phase0VSettings', 'Phase0WNotes', 'ItemAutomation', 'UnifiedHotkeys', 'EntityLabels', 'WorldTargets')]
...
$ownerTestCardName = if ($Profile -eq 'WorldTargets') {
...
$packageId = $(if ($Profile -eq 'WorldTargets') { 'world-targets-' } elseif ($Profile -eq 'EntityLabels') { 'entity-labels-' } elseif ($Profile -eq 'UnifiedHotkeys') { 'unified-hotkeys-' } elseif ($Profile -eq 'ItemAutomation') { 'item-automation-' } elseif ($Profile -eq 'Phase0WNotes') { 'phase0w-notes-' } elseif ($Profile -eq 'Phase0VSettings') { 'phase0v-settings-' } elseif ($Profile -eq 'Phase0UF5UI') { 'phase0u-f5-ui-' } elseif ($Profile -eq 'Phase0TBiome') { 'phase0t-biome-' } else { 'phase0s-' }) + $sourceCommit
