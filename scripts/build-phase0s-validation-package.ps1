...
$ownerTestCardName = if ($Profile -eq 'WorldObjectText') {
...
$packageId = $(if ($Profile -eq 'WorldObjectText') { 'world-object-text-' } elseif ($Profile -eq 'WorldTargets') { 'world-targets-' } elseif ($Profile -eq 'EntityLabels') { 'entity-labels-' } elseif ($Profile -eq 'UnifiedHotkeys') { 'unified-hotkeys-' } elseif ($Profile -eq 'ItemAutomation') { 'item-automation-' } elseif ($Profile -eq 'Phase0WNotes') { 'phase0w-notes-' } elseif ($Profile -eq 'Phase0VSettings') { 'phase0v-settings-' } elseif ($Profile -eq 'Phase0UF5UI') { 'phase0u-f5-ui-' } elseif ($Profile -eq 'Phase0TBiome') { 'phase0t-biome-' } else { 'phase0s-' }) + $sourceCommit
