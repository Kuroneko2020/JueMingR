...
param(
    ...
    [ValidateSet('Phase0S', 'Phase0TBiome', 'Phase0UF5UI', 'Phase0VSettings', 'Phase0WNotes')]
...
$ownerTestCardName = if ($Profile -ceq 'Phase0WNotes') {
...
$packageId = $(if ($Profile -ceq 'Phase0WNotes') { 'phase0w-notes-' } elseif ($Profile -eq 'Phase0VSettings') { 'phase0v-settings-' } elseif ($Profile -ceq 'Phase0UF5UI') { 'phase0u-f5-ui-' } elseif ($Profile -ceq 'Phase0TBiome') { 'phase0t-biome-' } else { 'phase0s-' }) + $sourceCommit
...
$packageDirectoryName = $(if ($Profile -ceq 'Phase0WNotes') { 'JueMingR-Phase0W-Notes-' } elseif ($Profile -eq 'Phase0VSettings') { 'JueMingR-Phase0V-Settings-' } elseif ($Profile -ceq 'Phase0UF5UI') { 'JueMingR-Phase0U-F5UI-' } elseif ($Profile -ceq 'Phase0TBiome') { 'JueMingR-Phase0T-Biome-' } else { 'JueMingR-Phase0S-' }) + $sourceCommit
