...
namespace NativeWorldTextProbe
{
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
            try
            {
                if (args.Length < 3 || args.Length > 4) throw new ArgumentException("repository Content output [Full|SelectionCpuCosts|SelectionCpuChecks|WorkloadCpu|InformationCpu] required");
