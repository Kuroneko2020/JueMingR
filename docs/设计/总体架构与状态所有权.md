...
- JueMingR 是原版 Terraria 客户端辅助工具；独立重写描述与 JueMingZ 的工程关系，旧版功能不构成产品上限。定位说明见[根 README](../../README.md)；本条背景澄清属 [ADR-0015（Proposed）](../决策/ADR-0015-产品定位与能力演进边界.md) 候选，其余有效架构、依赖方向和状态所有权不变。
